...
- to download, use : **wget https://github.com/massalabs/massa/releases/download/TEST.20.2/massa_TEST.20.2_release_linux.tar.gz** . Verify the version, here it's **20.2**.

## 2. Uncompress the file

If **tar** isn't install, you install it with **sudo apt install tar**

We use **tar** with our file like : **tar xzf massa_TEST.20.2_release_linux.tar.gz** where **20.2** is the number of the version.
