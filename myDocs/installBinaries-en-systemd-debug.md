...
- to download, use : **wget https://github.com/massalabs/massa/releases/download/TEST.23.1/massa_TEST.23.1_release_linux.tar.gz** . Verify the version, here it's **23.1**.

## 2. Uncompress the file

If **tar** isn't install, you install it with **sudo apt install tar**

We use **tar** with our file like : **tar xzf massa_TEST.23.1_release_linux.tar.gz** where **23.1** is the number of the version.
