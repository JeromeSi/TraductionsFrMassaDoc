...
- pour l'utiliser : **wget https://github.com/massalabs/massa/releases/download/TEST.26.0/massa_TEST.26.0_release_linux.tar.gz** Il faudra remplacer les **XX.X** par la version recherchée
