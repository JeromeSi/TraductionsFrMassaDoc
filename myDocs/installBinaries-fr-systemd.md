...
- pour l'utiliser : **wget https://github.com/massalabs/massa/releases/download/TEST.25.1/massa_TEST.25.1_release_linux.tar.gz** Il faudra remplacer les **XX.X** par la version recherchée
